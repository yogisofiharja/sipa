...
function simpleGallery(settingarg){
    ...
    } //create real deferred object unless preloadfirst setting is false or browser doesn't support it
    setting.longestdesc="" //get longest description of all slides. If no desciptions defined, variable contains ""
    setting.$loadinggif=(function(){ //preload and ref ajax loading gif
        var loadgif=new Image()
        loadgif.src=simpleGallery_navpanel.loadinggif
        return jQuery(loadgif).css({
    ...
    jQuery(document).ready(function($){
        ...
        setting.$loadinggif.css({
            top:setting.dimensions[1]/2-30
        }).appendTo(setting.$wrapperdiv) //30 is assumed height of ajax loading gif
...
simpleGallery.routines={
    ...
    getSlideHTML:function(imgelement){
        ...
        layerHTML+='<img height="350" src="'+imgelement[0]+'" style="border-width:0" />'
    ...
    addnavpanel:function(setting){
        ...
        .eq(1).css({
            ...
            textAlign:'center', 
            color:'white'
        }).html(interfaceHTML).end() //"navpanelfg" div
    ...
    adddescpanel:function(setting){
        ...
        .eq(0).css({
            background:'black', 
            opacity:simpleGallery_navpanel.panel.opacity
        }).end() //"gallerydescbg" div
        .eq(1).css({
            color:'white'
        }).end() //"gallerydescfg" div
