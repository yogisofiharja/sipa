...
window.FlexPaperViewer = window.$f = function() {
	...
	var _SWFFile,_PDFFile,_IMGFiles,_JSONFile  = "",_jsDirectory="";
			...
			if(true){
				$(document).ready(function() {
					$.getScript(conf.jsDirectory+'FlexPaperViewer.js', function() {
						...
						if(conf.PdfFile!=null && conf.PdfFile.length>0 && conf.RenderingOrder.split(",").length>1 && supportsPDFJS && (oRenderingList[0] == 'html5' || oRenderingList[1] == 'html5')){
